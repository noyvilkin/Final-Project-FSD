...
async function seed() {
  ...
  const dna = await ProfessionalDNA.create({
    ...
    rawResumeText: [
      'Dana Cohen',
      'demo@careerpilot.dev | +972-50-1234567 | https://linkedin.com/in/danacohen',
      '',
      'EXPERIENCE',
      '',
      'Senior Full Stack Developer — Skyline Tech (Jun 2022 – Present)',
      'Led the development of a multi-tenant SaaS platform serving 15K+ users. Built real-time dashboards using React and WebSocket, reduced API response times by 40% through query optimization and caching layers.',
      '',
      'Full Stack Developer — DataBridge Solutions (Mar 2020 – May 2022)',
      'Designed and implemented RESTful microservices handling 2M+ daily requests. Migrated legacy jQuery frontend to React with TypeScript, improving load times by 60%. Established CI/CD pipelines with GitHub Actions and Docker.',
      '',
      'Junior Developer — WebCraft Agency (Sep 2018 – Feb 2020)',
      'Developed responsive client websites using JavaScript, HTML/CSS, and Node.js. Maintained PostgreSQL databases and wrote automated test suites with Jest. Participated in daily standups and bi-weekly sprint planning.',
      '',
      'EDUCATION',
      '',
      'B.Sc. Computer Science — Tel Aviv University (2015 – 2018), GPA: 3.7',
      '',
      'SKILLS',
      '',
      'TypeScript, JavaScript, React, Node.js, Express, MongoDB, PostgreSQL, Docker, AWS, Git, REST API, GraphQL, Jest, CI/CD, Agile, Team Leadership',
    ].join('\n'),
    skills: [
